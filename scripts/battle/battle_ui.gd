...
@export var tree_mad_enemy_resource: EnemyData = preload("res://resources/pohon_meranti_marah.tres")
@export var dialogue_resource: DialogueResource
@export var enemy_resource: EnemyData
@export var snake_enemy_resource: EnemyData = preload("res://resources/ular_enggano.tres")
...
func _transition_to_snake_battle() -> void:
	if not snake_enemy_resource:
		snake_enemy_resource = load("res://resources/ular_enggano.tres")
...
func _transition_to_house_cutscene() -> void:
	...
	SceneTransition.change_scene("res://scenes/maps/rumahdonga.tscn")
...
func _trigger_tree_enrage() -> void:
	...
	if not tree_mad_enemy_resource:
		tree_mad_enemy_resource = load("res://resources/pohon_meranti_marah.tres")
